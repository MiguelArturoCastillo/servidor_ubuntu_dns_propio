                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-12 col-md-4"style="align-content: center"><div>
                                        <h6 class="mt-4">REGISTRO DE MATERIAS</h6>
                            ...
                            <div class="btn-group" role="group" aria-label="Basic outlined example">   
                                    <a href="buscar_materia.php" class="btn btn-outline-primary">BUSCAR MATERIAS</a>
                                    <a href="formulario_materia.php"class="btn btn-outline-primary">AGREGAR MATERIAS</a>
                                    <a href="principal.php"class="btn btn-secondary" style="align-content: center">VOLVER</a></div>
                            </div> 
                            </section>          
                </main>

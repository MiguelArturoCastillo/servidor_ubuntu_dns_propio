...
echo "Cantidad de notas guardadas del segundo cuatrimestre es: ".$m;
 ...
 $cadena='insert into calificaciones_seg(idcal_seg,idalumno,nota2_1,nota2_2,nota2_3,promedio_seg_cuatri_1,promedio_seg_cuatri_2) values (null,"'.$_REQUEST['txt_idalumno'].'","'.$_REQUEST['txt_calificacion2_1'].'","'.$_REQUEST['txt_calificacion2_2'].'","'.$_REQUEST['txt_calificacion2_3'].'","'.$prom_2.'","'.$prom_1_2.'")';

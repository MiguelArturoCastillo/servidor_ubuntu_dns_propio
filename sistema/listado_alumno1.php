                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-12 col-md-4"style="align-content: center"><div>
                                        <h6 class="mt-4">REGISTRO DE ALUMNOS SECUNDARIA TECNICA</h6>
                                        ...
                                        <a href="buscar_alumno.php" class="btn btn-outline-primary">BUSCAR ALUMNOS</a>
                                        <a href="formulario_alumno.php" class="btn btn-outline-primary">AGREGAR ALUMNOS</a>
                                        <a href="principal.php"class="btn btn-secondary" style="align-content: center" >VOLVER</a>
                                        <a href="prueba_reporte.php" target="_blank" class="btn btn-primary" style="align-content: center" >OBTENER PDF</a>
                                        <BR>
                                        </div> 
                            </section>          
                </main>

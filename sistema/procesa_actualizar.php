...
$cadena="UPDATE calificaciones set nota1_1='$nota1_1', nota1_2='$nota1_2', nota1_3='$nota1_3', promedio_pri_cuatri_1='$promedio_pri_cuatri_1', recuperacion_1='$recuperacion_1', promedio_pri_cuatri_2='$promedio_pri_cuatri_2' WHERE idalumno='$id'";

$cadena="UPDATE calificaciones_seg set nota2_1='$nota2_1', nota2_2='$nota2_2', nota2_3='$nota2_3', promedio_seg_cuatri_1='$promedio_seg_cuatri_1', recuperacion_2='$recuperacion_2', promedio_seg_cuatri_2='$promedio_seg_cuatri_2' WHERE idalumno='$id'";

$cadena="UPDATE calificaciones_fin set promedio_final='$promedio_final', fort_dic='$fort_dic', feb='$feb', promedio_final='$promedio_final' WHERE idalumno='$id'";

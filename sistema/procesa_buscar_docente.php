                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-12 col-md-4"style="align-content: center"><div>
                                        <h6 class="mt-4">RESULTADO DE LA BUSQUEDA DE OBJETO DOCENTE</h6>
                                        <p class="placeholder-wave">
                                        <span class="placeholder col-12"></span>
                                        </p>
                                        <?php
                                        include("class/clase_docente.php");
                                        $id=$_REQUEST['txt_iddocente'];
                                        $obj_docente=new docente("","","","");
                                        $obj_docente->mostrar_docente($id);
                                        ?>
                                        <BR>
                                        <BR>
                                        <a href="buscar_docente.php" class="btn btn-secondary" style="align-content: center">VOLVER</a> 
                                        </div>
                            </div>
                        </div>
                    </div>                                                   

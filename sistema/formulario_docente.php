                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-12 col-md-4"style="align-content: center"><div>
                                        <h6 class="mt-4">FORMULARO DOCENTE</h6>
                                        <p class="placeholder-wave">
                                        <span class="placeholder col-12"></span>
                                        </p>                 
                                        </DIV>
                                        <form method="POST" action="procesa_docente.php">
                                        <select name="lst_name">
                                        Unica opcion para elegir de nombre y apellido:<option value="MIGUEL CASTILLO" >MIGUEL CASTILLO</option>         
                                        </select>
                                        <!--NOMBRE Y APELLIDO: <input type="text" name="txt_apellido_nombre">-->    
                                        <br><br>               
                                        Celular: <input type="number" name="txt_celular">
                                        <br><br>
                                        Mail: <input type="text" name="txt_mail">
                                        <br><br>
                                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                                        <input type="submit" class="btn btn-outline-primary" value="Guardar">
                                        <a href="listado_docente.php" class="btn btn-secondary" style="align-content: center">VOLVER</a>
                                        </form>  
                                        </div>
                            <DIV>
                            <BR>

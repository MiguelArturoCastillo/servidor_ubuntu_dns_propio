                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-3 col-md-5"style="align-content: center"><div>
                                        <h6 class="mt-4">RESULTADO DE LA BUSQUEDA</h6>
                                        ...
                                        <a href="listado_alumno.php" class="btn btn-outline-primary">PARA AGREGAR/MODIFICAR CALIFICACIONES</a>          
                                        <a href="buscar_alumno.php" class="btn btn-secondary" style="align-content: center">VOLVER</a> 
                                        </div>
                            </div>
                        </div>
                    </div>                                                   

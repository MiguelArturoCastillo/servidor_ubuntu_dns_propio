                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-3 col-md-5"style="align-content: center"><div>
                                        <h6 class="mt-4">BUSCAR DOCENTE</h6>
                                        <p class="placeholder-wave">
                                        <span class="placeholder col-12"></span>
                                        </p>
                                        <form method="POST" action="procesa_buscar_docente.php">
                                        Ingrese Iddocente: <input type="text" name="txt_iddocente">
                                        <br><br>
                                        <input type="submit" value="Buscar"class="btn btn-success" >
                                        </form> 
                                        <br>
                                        <br>   
                                        <a href="listado_docente.php" class="btn btn-secondary">VOLVER AL REGISTRO DE DOCENTES</a>
                            </div>
                            </div>
                        </div>
                    </div>                                                   

...
echo "SE REALIZA CARGA DE CALIFICACION SEGUN RECUPERACION EXTRAORDINARIA DICIEMBRE: ".$promedio_final;
echo "<br>";
echo "<br>";
 ...
 $cadena='insert into calificaciones_fin(idcal_fin, idalumno, promedio_final) values (null,"'.$_REQUEST['txt_idalumno'].'","'.$promedio_final.'")';
 ...
 $mysql->close();
?>
<h3>CALIFICACIONES  EXITOSAMENTE GUARDADAS</H3>
<br>

                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-12 col-md-4"style="align-content: center"><div>
                                        <h6 class="mt-4">REGISTRO DE DOCENTES</h6>
                                        ...
                                        <!--<a href="buscar_docente.php" class="btn btn-outline-primary">BUSCAR DOCENTE</a>-->
                                        <a href="formulario_docente.php" class="btn btn-outline-primary">MODIFICAR DOCENTE</a>

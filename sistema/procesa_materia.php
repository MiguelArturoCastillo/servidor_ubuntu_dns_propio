                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-12 col-md-4"style="align-content: center"><div>
                                        <h6 class="mt-4">INGRESO MATERIA A LA BASE DE DATOS</h6>
                                        ...
                                        if ($tipo_usuario == 1) { 
                                        $no_ma=$_REQUEST['lst_curr1']; 
                                        $obj_materia=new materia("","");
                                        echo "<h6>MOSTRANDO OBJETO MATERIA CREADO:</h6>";
                                        echo $obj_materia->nombre_materia;
                                        echo "<br>"; 
                                        $obj_materia->guardar($no_ma);}
                                        else{
                                            echo "Debe contactarse con su administrador para poder ejecutar esta operación";
                                        }
                                        ?>
                                        <p class="placeholder-wave">
                                        <span class="placeholder col-12"></span>
                                        </p>
                                        <a href="listado_materia.php" class="btn btn-secondary" style="align-content: center" >VOLVER</a>
                                </div>
                            </div>                                
                    </div>
                    </section>

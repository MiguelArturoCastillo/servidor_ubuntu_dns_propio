                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-12 col-md-4"style="align-content: center"><div>
                                        <h6 class="mt-4">Resultado de la operacion eliminar curso</h6>
                                        ...
                                        <br>
                                        <br>
                                        <a href="listado_curso.php" class="btn btn-secondary">VOLVER AL REGISTRO DE CURSOS</a>
                                        </div>
                            </div>
                        </div>
                    </div>                                                   

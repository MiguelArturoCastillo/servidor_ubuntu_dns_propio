                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-12 col-md-4"style="align-content: center"><div>
                                        ...
                                        $cadena="select idalumno from calificaciones_fin WHERE idalumno=".$id;
                                        ...
                                        echo $id;                                        
                                        echo  
                                        '<form action="procesa_registrar_fin.php" method="POST">
                                        <br>
                                        IDalumno:<input type="text" name="txt_idalumno" value='.$id.' readonly>
                                        <h6 class="mt-4">Primer cuatrimestre</h6>
                                        RECUPERACION DICIEMBRE <input type="number" name="txt_diciembre" required>
                                        <br><br>
                                        <p class="placeholder-wave">
                                        <span class="placeholder col-12"></span>
                                        </p>

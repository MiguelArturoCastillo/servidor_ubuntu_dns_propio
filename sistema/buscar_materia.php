                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
									...
									<a class="nav-link" href="layout-static.html">Listado de alumnos</a>
									<a class="nav-link" href="layout-static.html">Listado de cursos</a>
									<a class="nav-link" href="layout-static.html">Listado de docentes</a>
									<a class="nav-link" href="layout-static.html">Planilla de curso</a>
                                </nav>
                            </div>
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                                <div class="sb-nav-link-icon"><i class="fas fa-book-open"></i></div>
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-3 col-md-5"style="align-content: center"><div>
                                        <h6 class="mt-4">BUSCAR MATERIA</h6>
                                        <p class="placeholder-wave">
                                        <span class="placeholder col-12"></span>
                                        </p>
                                        <form method="POST" action="procesa_buscar_materia.php">
                                        BUSCAR MATERIA POR IDMATERIA: <input type="text" name="txt_materia">
                                        <br><br>
                                        ...
                                        <br>
                                        <br>   
                                        <a href="listado_materia.php" class="btn btn-secondary">VOLVER AL REGISTRO DE MATERIA</a>
                                </div>
                            </div>
                        </div>
                    </div>                                                   

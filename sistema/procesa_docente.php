                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-12 col-md-4"style="align-content: center"><div>
                                        <h6 class="mt-4">MODIFICANDO LA BASE DE DATOS</h6>
                                        ...
                                        echo "<h6>MOSTRANDO OBJETO DOCENTE MODIFICADO. <BR><BR> <HR> SOLO SE PUEDE MODIFICAR DATOS DEL DOCENTE AUTORIZADO POR EL ADMINISTRADOR</h6>";
                                        echo "<br>";
                                        echo "Nombre y apellido:  ".$obj_docente->apellido_nombre;
                                        echo "<br>";
                                        echo "Celular:  ".$obj_docente->celular;
                                        echo "<br>";
                                        echo "mail:  ".$obj_docente->mail;
                                        echo "<br> <HR>";
                                        $obj_docente->guardar();

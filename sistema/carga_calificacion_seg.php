                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-12 col-md-4"style="align-content: center"><div>
                                        <h6 class="mt-4">REGISTRAR CALIFICACIONES</h6>
                                        ...
                                        $cadena="select idalumno from calificaciones_seg WHERE idalumno=".$id;
                                        ...
                                        {
                                        echo "No se encuentra registro el idalumno seleccionado :";                                        
                                        echo $id;                                        
                                        echo  
                                        '<form action="procesa_registrar_seg.php" method="POST">
                                        <br>
                                        IDalumno:<input type="text" name="txt_idalumno" value='.$id.' readonly>
                                        <h6 class="mt-4">Primer cuatrimestre</h6>
                                        ...
                                        <h6 class="mt-4">Segundo cuatrimestre</h6>

                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <div >
                                <div class="col-xl-12 col-md-4"style="align-content: center"><div>
                                        <h6 class="mt-4">FORMULARO DEL CURSO</h6>
                                        <p class="placeholder-wave">
                                        <span class="placeholder col-12"></span>
                                        </p>                       
                                        <form method="POST" action="procesa_curso.php">
                                        <br>
                                        <h6 class="mt-4">SELECCIONE UN ID CURSO</h6>
                                        <select name="lst_tio1">
                                        ...
                                        <br>
                                        <br>
                                        <h6 class="mt-4">SELECCIONE UN TURNO</h6>
                                        <select name="lst_turno">
                                        ...
                                        <br>
                                        <br>
                                        <h6 class="mt-4">SELECCIONE UN CICLO ESCOLAR</h6>
                                        <select name="lst_ciclo1"> 
                                        ...
                                        <a href="listado_curso.php" class="btn btn-secondary" style="align-content: center">VOLVER</a>
                                        </div>
                                        </form>  
                                        <br>
                                        <hr>
